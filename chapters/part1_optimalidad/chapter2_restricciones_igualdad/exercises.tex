...
\addsubsec{Parte I: Mecánica Primal-Dual y Fallas Topológicas}

\begin{exercise}\label{v1:ejer:2.1}
...
\begin{exercise}\label{v1:ejer:2.2}
...
\begin{exercise}\label{v1:ejer:2.3}
...
\begin{exercise}\label{v1:ejer:2.4}
...
\begin{exercise}[Pérdida de la condición LICQ por reformulación no lineal]\label{v1:ejer:2.5}
...
\begin{exercise}[El Cilindro y el Plano Tangente]\label{v1:ejer:2.6}
...
\begin{exercise}[Dependencia Funcional y Conjuntos de Nivel]\label{v1:ejer:2.7}
...
\begin{exercise}[Intersección de dimensión mixta y puntos aislados]\label{v1:ejer:2.8}
...
\addsubsec{Parte II: Condiciones Diferenciales de Segundo Orden y Matriz KKT}

\begin{exercise}\label{v1:ejer:2.9}
...
\begin{exercise}[El Sistema Lineal de Karush-Kuhn-Tucker]\label{v1:ejer:2.10}
...
\begin{exercise}[No-singularidad Numérica de la Matriz KKT]\label{v1:ejer:2.11}
...
\begin{exercise}[Valores Propios como Extremos de Rayleigh]\label{v1:ejer:2.12}
...
\begin{exercise}[Degeneración de la Condición Necesaria]\label{v1:ejer:2.13}
...
\begin{exercise}[Descomposición Espectral en Lagrange]\label{v1:ejer:2.14}
...
\begin{exercise}[Puntos de Ensilladura Restringidos]\label{v1:ejer:2.15}
...
\begin{exercise}[La Matriz Fronteada (Bordered Hessian)]\label{v1:ejer:2.16}
...
\addsubsec{Parte III: Aplicaciones Físicas, Análisis de Sensibilidad y Variedades Matriciales}

\begin{exercise}[Precio Sombra y Análisis de Sensibilidad]\label{v1:ejer:2.17}
...
\begin{exercise}[Problema Isoperimétrico de Herón]\label{v1:ejer:2.18}
...
\begin{exercise}[Principio de Fermat y la Ley de Snell]\label{v1:ejer:2.19}
...
\begin{exercise}[Distribución Uniforme y Entropía de Shannon]\label{v1:ejer:2.20}
...
\begin{exercise}[Proyección sobre el Grupo Ortogonal: El Problema de Procrustes]\label{v1:ejer:2.21}
...
\begin{exercise}[Mecánica Clásica: El Péndulo Simple]\label{v1:ejer:2.22}
...
\begin{exercise}[Microeconomía: Maximización de Utilidad]\label{v1:ejer:2.23}
...
\begin{exercise}[Problema de Optimización de Carteras de Markowitz]\label{v1:ejer:2.24}
...
\begin{exercise}[Mínimos Cuadrados Restringidos]\label{v1:ejer:2.25}
