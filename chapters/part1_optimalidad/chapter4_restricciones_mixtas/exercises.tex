...
\vspace{0.5em}
\noindent\textbf{Parte I: Mecánica Primal-Dual y Condición de Mangasarian-Fromovitz}
\vspace{0.5em}
...
\vspace{1em}
\noindent\textbf{Parte II: Condiciones de Segundo Orden}
\vspace{0.5em}
...
\vspace{1em}
\noindent\textbf{Parte III: Tópicos Avanzados - Dualidad, Conos Convexos y KKT Singular}
\vspace{0.5em}
