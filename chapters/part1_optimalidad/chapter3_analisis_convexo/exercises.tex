...
\addsubsec{Parte IV: Teoremas de Alternativa y Análisis Convexo}

\begin{exercise}[Teorema de Tucker]
...
\begin{exercise}[Teoremas de Gale I y II]
...
\begin{exercise}[Teoremas de Gordan y Stiemke]
...
\begin{exercise}
    Sean $\alpha_i > 0, \ i=1,\dots,p$. Probar utilizando propiedades de funciones convexas (Cobb-Douglas):
    \[
...
\begin{exercise}
    Sea $f$ una función convexa y al mismo tiempo cóncava. Mostrar que esto implica que $f$ es una función afín ($f(x) = \interno{a}{x} + c$).
\end{exercise}
...
\begin{exercise}
    ...
    \begin{enuthm}
        ...
        \item $f(x) = \E^{\interno{Qx}{x}}$, donde $Q$ es semidefinida positiva.
    \end{enuthm}
\end{exercise}
...
\begin{exercise}
    Probar que la función $f(x) = \max\{ \E^x, x^2 \} + 1/x$ es convexa en $\R_+ \setminus \{0\}$.
\end{exercise}
