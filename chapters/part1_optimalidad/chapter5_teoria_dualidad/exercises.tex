...
\addsec{Ejercicios del Capítulo 5}

\vspace{0.5em}
\noindent\textbf{Parte I: Dualidad en Programación Lineal}
\vspace{0.5em}

\begin{exercise}[Dualidad en formato lineal general]
...
\begin{exercise}[Verificación numérica de dualidad]
...
\begin{exercise}[Acotamiento y optimalidad en sistemas homogéneos]
...
\begin{exercise}[Análisis de sensibilidad paramétrica]
...
\vspace{1em}
\noindent\textbf{Parte II: Dualidad en Problemas Generales y Puntos de Silla}
\vspace{0.5em}

\begin{exercise}[Dual de un problema de programación cuadrática]
...
\begin{exercise}[Cálculo analítico de la función dual]
...
\begin{exercise}[Dualidad en problemas de proyección]
...
\begin{exercise}[Invariancia y dependencia de la formación dual]
...
\begin{exercise}[Teorema de Everett]
...
\begin{exercise}[Puntos de Silla e Igualdad Minimax]\label{ex:minimax_punto_silla}
...
\begin{exercise}[Proyección sobre un semiespacio]
...
\begin{exercise}[Descomposición dual en optimización separable]
...
\begin{exercise}[Formulación de Consenso y Descomposición Dual]
