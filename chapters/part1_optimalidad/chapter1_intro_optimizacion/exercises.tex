...
\begin{exercise}\label{v1:ejer:1.1}
 Mediante un dibujo geométrico, formular una hipótesis sobre la solución global del problema \eqref{v1:eq:1.1}, donde:
 \begin{enuthm}
...
\begin{exercise}\label{v1:ejer:1.2}
 Mediante un dibujo geométrico, responder a la siguiente pregunta: para qué valores del parámetro $\sigma \in \R$ el problema \eqref{v1:eq:1.1} con $f(x) = x_1 + \sigma x_2$ y $D = \{x \in \R^2 \mid x_1^3 + x_2^3 = 3x_1x_2\}$, tiene una solución global y para cuáles solo una solución local.
\end{exercise}

\begin{exercise}\label{v1:ejer:1.3}
...
\begin{exercise}\label{v1:ejer:1.4}
...
\begin{exercise}\label{v1:ejer:1.5}
...
\begin{exercise}\label{v1:ejer:1.6}
 Probar el \cref{v1:cor:1.2.3}. (Ayuda: Usar el razonamiento analítico del \cref{v1:exa:1.2.1}).
\end{exercise}

\begin{exercise}\label{v1:ejer:1.7}
 Sea $D$ un conjunto compacto no vacío. Suponiendo que $f$ sea semicontinua inferiormente en $D$ (ver \cref{v1:def:1.2.4}), probar que existe un minimizador global para el problema \eqref{v1:eq:1.1}. Suponiendo que $f$ sea semicontinua superiormente en $D$, probar que existe un maximizador global.
\end{exercise}

\begin{exercise}\label{v1:ejer:1.8}
 Sean $D \subset \Rn$ y $f : D \to \R$ una función semicontinua inferiormente y coercitiva en $D \neq \emptyset$. Probar que el problema \eqref{v1:eq:1.1} posee una solución global.
\end{exercise}

\begin{exercise}\label{v1:ejer:1.9}
...
\begin{exercise}\label{v1:ejer:1.10}
...
\begin{exercise}\label{v1:ejer:1.11}
...
\begin{exercise}\label{v1:ejer:1.12}
...
\begin{exercise}\label{v1:ejer:1.13}
...
\begin{exercise}\label{v1:ejer:1.14}
...
\begin{exercise}\label{v1:ejer:1.15}
...
\begin{exercise}\label{v1:ejer:1.16}
...
\begin{exercise}\label{v1:ejer:1.17}
...
\begin{exercise}\label{v1:ejer:1.20}
...
\begin{exercise}\label{v1:ejer:1.21}
 Mostrar que en $\Rn$ la condición de optimalidad primal \eqref{v1:eq:1.13} es equivalente a:
 \[
 \forall \varepsilon > 0, \quad \interno{\nabla f(\bar{x})}{d} > -\varepsilon \norm{d} \quad \forall d \in \mathcal{B}_D(\bar{x}) \setminus \{0\}.
 \]
\end{exercise}

\begin{exercise}\label{v1:ejer:1.22}
...
\begin{exercise}\label{v1:ejer:1.23}
...
\begin{exercise}\label{v1:ejer:1.24}
