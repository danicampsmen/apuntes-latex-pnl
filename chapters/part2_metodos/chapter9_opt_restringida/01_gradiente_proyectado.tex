...
\begin{theorem}[Convergencia del método del gradiente proyectado]\label{thm:4.1.1}
...
\begin{theorem}[Convergencia lineal del método del gradiente proyectado]\label{thm:4.1.2}
