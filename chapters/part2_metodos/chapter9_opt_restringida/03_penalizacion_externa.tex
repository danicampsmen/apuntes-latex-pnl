...
\begin{theorem}[Convergencia de soluciones locales de problemas penalizados]\label{th:4.3.2}
...
\begin{theorem}[Tasa de convergencia de métodos de penalización externa]\label{th:4.3.3}
...
\begin{theorem}[Condiciones necesarias para penalización exacta]\label{th:4.3.4}
...
\begin{theorem}[Penalización exacta en el caso convexo]\label{th:4.3.5}
...
\begin{theorem}[Penalización exacta en el caso de la condición suficiente de segunda orden]\label{th:4.3.6}
