...
Para el análisis y evaluación de métodos con convergencia asintótica, la cuestión de la \deftech{tasa de convergencia} es una de las más importantes. La tasa de convergencia es uno de los principales indicadores de eficiencia de un método iterativo. En esta sección, hablaremos sobre la convergencia en relación a las variables del problema. Para cualquier otro tipo de convergencia, la definición de tasa es completamente análoga.
...
\]
decimos que el método posee \deftech{convergencia lineal}. Cuando en la relación anterior $q = 0$, hablamos de \deftech{convergencia superlineal}. La convergencia más lenta que la lineal es llamada \deftech{sublineal}. Un caso especial de convergencia superlineal es la \deftech{convergencia cuadrática}:
\[
...
\]
En este caso, hablamos de \deftech{convergencia aritmética}. Cuando
\[
    \limsup_{k \to \infty} \frac{\|x^k - \bar{x}\|}{q^k} \le C,
\]
donde $q \in (0, 1)$, hablamos de \deftech{convergencia geométrica}. Es obvio que la tasa lineal implica convergencia geométrica, pero no recíprocamente.
