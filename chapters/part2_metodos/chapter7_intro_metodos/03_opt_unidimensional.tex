...
\begin{definition}\label{v2:def:2.3.1}
    Decimos que una función $f \colon [a, b] \to \R$ es \textbf{unimodal} (en $[a, b]$), cuando ella tiene un único minimizador global $\bar{x}$ en $[a, b]$, y es estrictamente decreciente en $[a, \bar{x}]$ y estrictamente creciente en $[\bar{x}, b]$, i.e.,
    \begin{align*}
